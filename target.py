...
def banner():
    ...
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   NEW TOOLS HACK FACEBOOK FB.   ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: MR.T4A33Z             |"
    print GL+"  |       FACEBOOK :  PRANTO AHMED        |"
    print WW+"  |        TEAM : BD CYBER ZONE  ErRoR SyStEm            |"
    print Y+"  |             INSTAGRAM: PRANTO_AHMED              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ T.A.Z ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   HACK FACEBOOK TAZ ^_^   •••••••••|"
    print GG+"  √=============================================√"

banner()

print wd+"         gunakan dengan bijak cok "
print GG+"╭────\033[91m[\033[96m Prantovau ID\033[95m / \033[96mUsername Target\033[91m ] "
email_target = str(raw_input(GL+"\033[92m╰────➲\033[93m  "))
print " "
print "\033[92m╭────\033[91m[ \033[96mPrantovau File Wordlist \033[95m( pass.txt ) \033[91;1m]"
